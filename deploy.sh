...
clear
echo ""
echo -e "  ${BOLD}${WHITE}HASIB HOSSEN TECH DEPLOYER${RESET}"
echo -e "  ${MAGENTA}MADE BY HASIB HOSSEN${RESET}"
echo -e "  ${GREEN}t.me/bouchor${RESET}"
echo ""
...
read -r -p "$(echo -e "  ${CYAN}SERVICE NAME [hasib]: ${RESET}")" INPUT_NAME
SERVICE_NAME=${INPUT_NAME:-hasib}
...
echo -e "  ${CYAN}PASS       ${GREEN}hasib${RESET}"
...
echo ""
echo -e "  ${CYAN}TROJAN       ${GREEN}/hasib${RESET}"
echo -e "  ${CYAN}VMESS        ${GREEN}/vmess-hasib${RESET}"
echo -e "  ${CYAN}VLESS        ${GREEN}/vless-hasib${RESET}"
echo -e "  ${CYAN}SHADOWSOCKS  ${GREEN}/ss-hasib${RESET}"
echo ""
